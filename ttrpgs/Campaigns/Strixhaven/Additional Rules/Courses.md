...
## First-Year Courses
Found below are the courses, professors, and rewards for each college. Some Professors or Instructors are taken from the published material, some are taken as inspiration from various cards in the Magic: The Gathering Strixhaven set and others are made up. 

### General Studies Courses

#### A Is For Ankheg: A Complete Guide On 26 Classic Monsters. (Required)
**Associated Skills:** [[skills#Animal Handling|Animal Handling]], [[skills#Nature|Nature]], [[skills#Survival|Survival]]
Taught by [[Professor Verelda Lang]], a dryad who only teaches General Studies courses about magical flora and fauna. The reward for completing this course is identical to the rewards from the Magical Physiologies class this one replaces. During the incident with mascots in the Party At The Rose Stage adventure I would recommend having one of the wands summon a [[chimera-xmm|Chimera]] instead of making a mascot amalgamation with the same stats. Ideas for lessons include
 - "B is for Basilisk, C is for Chimera"* and so forth.  Students will spend time in the Biblioplex researching creatures forhomework.

#### Basking In the Glow: Basic Magical Auras
**Associated Skills:** [[skills#Arcana|Arcana]],[[skills#Investigation|Investigation]], [[skills#Perception|Perception]]
This class is led by a vedalken named [[Professor Orvlo]]. 
In this class they teach students about the patterns left behind by different schools of magic and encourages them to look for those
patterns in the higher level spells they'll eventually go on to learn. As a reward for passing this class students are taught to cast [[detect-magic-xphb|Detect Magic]]

#### Flame of Knowledge: Lessons From the Founders
**Associated Skills:** [[skills#Arcana|Arcana]], [[skills#History|History]],[[skills#Insight|Insight]]
Instructor [[Lianna Flametongue]] teaches this class as a special offering. 
She instructs students on the history of Strixhaven and passes on the valuable lessons left behind by the Founder Dragons. The reward for passing this class is the [[dragons-breath-xphb|Dragon's Breath]] spell.

#### Speaking the Same Language: Overview of Magical Notation
**Associated Skills:**  [[skills#Arcana|Arcana]],[[skills#History|History]], [[skills#Insight|Insight]]
This course is taught by [[Xyla Langnig]], a relatively young female gnome, a dust speaker, and one of the newest [[Lorehold Professors of Order]].  
Xyla teaches students about common symbols and notations used by mages from all walks of life when writing about spells. The reward for passing this class is the [[comprehend-languages-xphb|Comprehend Languages]] spell.
