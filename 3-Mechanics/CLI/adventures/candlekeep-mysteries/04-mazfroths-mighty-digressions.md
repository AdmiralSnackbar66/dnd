...
- Coppers to Crowns, an "antiques" shop selling a miscellany of trinkets and oddities (roll `dice:2d4` times on the [Trinkets table](3-Mechanics/CLI/items/trinket-xphb.md) in the "Player's Handbook"). Each trinket costs `dice:2d10` cp.  
